 ...
 *  The OS detection and instruction text live in core/ollamaInstall so the
 *  CLI prints exactly what the IDE shows.                                  */

import * as vscode from 'vscode';
import { InstallationInfo, detectOS, getInstallationInfo } from '../core/ollamaInstall';
